...
/**
 * BaselineMetricsComponent displays performance metrics for the DSVT-Voxel baseline.
 *
 * Features:
 * - Displays all baseline metrics (accuracy, latency, violations, memory, SLO compliance)
 ...
 *
 * @see PRD FR-3.1 (Display DSVT-Voxel metrics)
 ...
 */
@Component({
  selector: 'app-baseline-metrics',
  standalone: true,
  imports: [CommonModule, MatCardModule, MatIconModule],
  templateUrl: './baseline-metrics.component.html',
  styleUrls: ['./baseline-metrics.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BaselineMetricsComponent implements OnChanges, OnDestroy {
  /**
